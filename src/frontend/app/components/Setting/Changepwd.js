      ...
      <div className='changepwd toolbar-page' ref='changepwdBox'>
        ...
        <div className='changepwd-content toolbar-page-content'>
          <QueueAnim delay={300} className='queue-simple'>
            <div key='1' className={oldpwdIsError ? 'input-wrapper validata-error' : 'input-wrapper'}>
            ...
            <div key='2' className={newpwdIsEmpty ? 'input-wrapper validata-error' : 'input-wrapper'}>
            ...
            <div key='3' className={confirmpwdIsError ? 'input-wrapper validata-error' : 'input-wrapper'}>
